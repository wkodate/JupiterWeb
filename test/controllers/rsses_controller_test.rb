...
class RssesControllerTest < ActionController::TestCase
  ...
  test "should create rss" do
    assert_difference('Rss.count') do
      post :create, rss: { crawl: @rss.crawl, description: @rss.description, rss_url: @rss.rss_url, site_link: @rss.site_link, title: @rss.title }
    end
  ...
  test "should update rss" do
    patch :update, id: @rss, rss: { crawl: @rss.crawl, description: @rss.description, rss_url: @rss.rss_url, site_link: @rss.site_link, title: @rss.title }
    assert_redirected_to rss_path(assigns(:rss))
  end
